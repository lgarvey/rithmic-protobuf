...
var file_request_volume_profile_minute_bars_proto_rawDesc = []byte{
	...
	0x75, 0x6d, 0x65, 0x42, 0x61, 0x72, 0x73, 0x42, 0x1e, 0x5a, 0x1c, 0x67, 0x69, 0x74, 0x68, 0x75,
	0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6c, 0x67, 0x61, 0x72, 0x76, 0x65, 0x79, 0x2f, 0x64, 0x6f,
	0x6d, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f,
}
...
var file_request_volume_profile_minute_bars_proto_goTypes = []interface{}{
...
func file_request_volume_profile_minute_bars_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_request_volume_profile_minute_bars_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RequestVolumeProfileMinuteBars); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
