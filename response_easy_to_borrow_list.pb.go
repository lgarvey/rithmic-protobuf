...
var file_response_easy_to_borrow_list_proto_rawDesc = []byte{
	...
	0x28, 0x08, 0x52, 0x0a, 0x62, 0x6f, 0x72, 0x72, 0x6f, 0x77, 0x61, 0x62, 0x6c, 0x65, 0x42, 0x1e,
...
var file_response_easy_to_borrow_list_proto_goTypes = []interface{}{
...
func file_response_easy_to_borrow_list_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_response_easy_to_borrow_list_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ResponseEasyToBorrowList); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
