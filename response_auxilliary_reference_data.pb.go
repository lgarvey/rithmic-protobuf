...
var file_response_auxilliary_reference_data_proto_rawDesc = []byte{
	...
	0x41, 0x53, 0x55, 0x52, 0x45, 0x5f, 0x51, 0x54, 0x59, 0x10, 0x80, 0x08, 0x42, 0x1e, 0x5a, 0x1c,
...
var file_response_auxilliary_reference_data_proto_goTypes = []interface{}{
...
func file_response_auxilliary_reference_data_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_response_auxilliary_reference_data_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ResponseAuxilliaryReferenceData); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
